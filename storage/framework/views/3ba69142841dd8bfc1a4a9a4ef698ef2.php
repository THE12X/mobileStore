...
<body>
    <nav class='navbar'>
        <h1 class='logo'>XMM</h1> Welcome, <?php echo e(Auth::user()->name); ?>

        <input type="checkbox" id="toggler" />
        <label for="toggler"><i class="fa fa-list"></i></label>
        <div class='menu'><span style="color:transparent">.</span>
            <ul class='list'>
                <li><a class="link" href="<?php echo e(route('home.Products')); ?>">Products</a></li>
                <li><a class="link" href="<?php echo e(route('home.Games')); ?>">Games</a></li>
                <li><a class="link" href="<?php echo e(route('home.Contact')); ?>">Contact</a></li>
                <li>
...
<?php /**PATH C:\Users\THE X\Desktop\PFE\resources\views/home.blade.php ENDPATH**/ ?>