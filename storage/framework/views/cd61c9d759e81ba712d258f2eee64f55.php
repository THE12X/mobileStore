    ...
    <script>
        window.addEventListener("DOMContentLoaded", function(event) {
            ...
            function resetGame() {
                ...
                applePosition =
                    100; // Initially the apple is always at the same position to make sure it's reachable
            ...
            function main(timestamp) {
                try {
                    ...
                    const followMe =
                        'Follow me <a href="#">@MRX</a>';
                    noteElement.innerHTML =
                        `${error.message}. ${pressSpaceToStart} <div>${changeMode}</div> ${followMe}`;
                    noteElement.style.opacity = 1;
...
<?php /**PATH C:\Users\THE X\Desktop\PFE\resources\views/Games/stack.blade.php ENDPATH**/ ?>